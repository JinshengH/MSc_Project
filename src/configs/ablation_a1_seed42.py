...
# Exp 4 architecture ablation (guide 5.2), A1: concat only (no cross-attention, no diff/product).
...
if __name__ == "__main__":
    ...
    main(config, config_name="ablation_a1_seed42")
